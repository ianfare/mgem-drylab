...
# Get arguments in the following order:
#   run_number
#   passive_signal_production
#   active_signal_production
#   factor_production
#   Dz
#   Rz
#   signal_thresh
...
# Which of the indexed sets of parameters to try (from run_model.py)
...
Rz=float(sys.argv[6])
# Signal threshold for active/passive
signal_thresh = float(sys.argv[7])
# Diffusion & decay coefficients for factor
